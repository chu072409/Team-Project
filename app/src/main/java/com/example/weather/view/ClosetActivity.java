...
public class ClosetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_closet); // activity_closet -> fragment_closet로 수정
        ...
        adapter = new ClothingAdapter(this, clothingList, () -> loadClothes("전체"));
